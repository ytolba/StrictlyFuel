...
const styles = StyleSheet.create({
  eyebrow: { color: strictlyColors.good, fontFamily: strictlyType.semibold, fontSize: 11, letterSpacing: 1.1 }, title: { color: strictlyColors.text, fontFamily: strictlyType.bold,  fontSize: 27, letterSpacing: -0.8, marginTop: 8 }, description: { color: strictlyColors.textSoft, fontFamily: strictlyType.regular, fontSize: 13, lineHeight: 20, marginTop: 8 },
  switch: { flexDirection: "row", padding: 4, borderRadius: strictlyRadius.medium, backgroundColor: strictlyColors.surfaceMuted, marginTop: 20 }, switchItem: { flex: 1, height: 42, alignItems: "center", justifyContent: "center", borderRadius: 9 }, switchActive: { backgroundColor: strictlyColors.ink }, switchText: { color: strictlyColors.textSoft, fontFamily: strictlyType.medium, fontSize: 12, textTransform: "capitalize" }, switchTextActive: { color: strictlyColors.lime, fontFamily: strictlyType.bold },
  label: { fontFamily: strictlyType.semibold, color: strictlyColors.textSoft, fontSize: 11, letterSpacing: 1.1, marginTop: 18, marginBottom: 7 }, heightRow: { flexDirection: "row", gap: 9 }, inputWrap: { flex: 1, height: 58, flexDirection: "row", alignItems: "center", paddingHorizontal: 15, borderRadius: strictlyRadius.medium, backgroundColor: strictlyColors.surface, borderWidth: 1, borderColor: strictlyColors.borderStrong }, input: { flex: 1, color: strictlyColors.text, fontFamily: strictlyType.bold,  fontSize: 21 }, unit: { color: strictlyColors.textSoft, fontFamily: strictlyType.semibold, fontSize: 11 },
  healthCard: { flexDirection: "row", alignItems: "center", gap: 10, padding: 14, marginTop: 22, borderRadius: strictlyRadius.large, backgroundColor: strictlyColors.cream }, healthIcon: { width: 38, height: 38, borderRadius: 14, backgroundColor: strictlyColors.lime, alignItems: "center", justifyContent: "center" }, healthCopy: { flex: 1 }, healthTitle: { color: strictlyColors.text, fontFamily: strictlyType.bold,  fontSize: 12 }, healthText: { color: strictlyColors.textSoft, fontFamily: strictlyType.regular, fontSize: 11, lineHeight: 14, marginTop: 3 }, toggle: { width: 46, height: 28, borderRadius: 14, padding: 3, backgroundColor: strictlyColors.borderStrong }, toggleActive: { backgroundColor: strictlyColors.ink }, toggleKnob: { width: 22, height: 22, borderRadius: 11, backgroundColor: strictlyColors.white }, toggleKnobActive: { alignSelf: "flex-end", backgroundColor: strictlyColors.lime },
});
