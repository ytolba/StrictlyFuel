...
const styles = StyleSheet.create({
  ...
  topCopy: { flex: 1 },
  eyebrow: { fontFamily: strictlyType.mono, color: strictlyColors.sage, fontSize: 11, letterSpacing: 0.3 },
  ...
  timeText: { color: strictlyColors.white, fontFamily: strictlyType.mono, fontSize: 11 },
  number: { fontFamily: strictlyType.sansMedium, fontWeight: "700", fontSize: 46, letterSpacing: -2, color: strictlyColors.white, marginTop: 22 },
  ...
  speed: { marginTop: 20 },
  speedTitle: { fontFamily: strictlyType.mono, color: strictlyColors.sage, fontSize: 11, letterSpacing: 0.3, marginBottom: 10 },
