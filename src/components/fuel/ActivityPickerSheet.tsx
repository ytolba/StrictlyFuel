...
const styles = StyleSheet.create({
  ...
  eyebrow: { fontFamily: strictlyType.mono, color: strictlyColors.good, fontSize: 11, letterSpacing: 0.3 },
  title: { fontFamily: strictlyType.sansMedium, fontWeight: "700", color: strictlyColors.text, fontSize: 25, letterSpacing: -0.7, marginTop: 5 },
  ...
  section: { marginTop: 22 }, sectionLabel: { fontFamily: strictlyType.mono, color: strictlyColors.textSoft, fontSize: 11, letterSpacing: 0.3, marginBottom: 9 },
  ...
  activityText: { flex: 1, fontFamily: strictlyType.sansMedium, fontWeight: "700", color: strictlyColors.text, fontSize: 11 }, activityTextActive: { color: strictlyColors.onLime },
