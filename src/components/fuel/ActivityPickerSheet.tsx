...
const styles = StyleSheet.create({
  ...
  eyebrow: { fontFamily: strictlyType.semibold, color: strictlyColors.good, fontSize: 11, letterSpacing: 1.1 },
  title: { fontFamily: strictlyType.bold,  color: strictlyColors.text, fontSize: 25, letterSpacing: -0.7, marginTop: 5 },
  ...
  searchInput: { flex: 1, color: strictlyColors.text, fontFamily: strictlyType.regular, fontSize: 15 },
  content: { paddingHorizontal: 20, paddingTop: 20, paddingBottom: 40 },
  section: { marginTop: 22 }, sectionLabel: { fontFamily: strictlyType.semibold, color: strictlyColors.textSoft, fontSize: 11, letterSpacing: 1.1, marginBottom: 9 },
  ...
  activityCompact: { minHeight: 54 }, activityActive: { backgroundColor: strictlyColors.lime, borderColor: strictlyColors.lime },
  activityIcon: { width: 34, height: 34, borderRadius: 11, backgroundColor: strictlyColors.surfaceMuted, alignItems: "center", justifyContent: "center" }, activityIconActive: { backgroundColor: strictlyColors.ink },
  activityText: { flex: 1, fontFamily: strictlyType.bold,  color: strictlyColors.text, fontSize: 11 }, activityTextActive: { color: strictlyColors.onLime },
  star: { width: 24, height: 34, alignItems: "center", justifyContent: "center" }, empty: { fontFamily: strictlyType.regular, color: strictlyColors.textSoft, fontSize: 13, marginTop: 8 },
});
