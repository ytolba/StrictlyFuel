...
const styles = StyleSheet.create({
  ...
  brandName: { color: cardColors.text, fontSize: 15, fontWeight: "700", letterSpacing: -0.3 },
  ...
  fuelPillText: { color: cardColors.text, fontSize: 11, fontWeight: "600" },
  photoCopy: { position: "absolute", left: 18, right: 18, bottom: 16 },
  activity: { color: cardColors.lime, fontSize: 12, fontWeight: "700" },
  mealName: { color: cardColors.text, fontSize: 27, lineHeight: 30, fontWeight: "700", letterSpacing: -0.8, marginTop: 6 },
  timing: { color: cardColors.textSoft, fontSize: 12, fontWeight: "500", marginTop: 6 },
  ...
  heroValue: { color: cardColors.text, fontSize: 38, lineHeight: 40, fontWeight: "700", letterSpacing: -1.6, fontVariant: ["tabular-nums"] },
  heroLabel: { color: cardColors.textSoft, fontSize: 11, fontWeight: "600", marginTop: 2 },
  ...
  scoreValue: { color: cardColors.ground, fontSize: 27, lineHeight: 29, fontWeight: "700", letterSpacing: -1, fontVariant: ["tabular-nums"] },
  scoreOutOf: { color: cardColors.ground, opacity: 0.7, fontSize: 11, fontWeight: "700", marginLeft: 2 },
  scoreLabel: { color: cardColors.ground, fontSize: 11, fontWeight: "700" },
  ...
  macroValue: { color: cardColors.text, fontSize: 14, fontWeight: "700", fontVariant: ["tabular-nums"] },
  macroLabel: { color: cardColors.textSoft, fontSize: 11, fontWeight: "500", marginTop: 2 },
  ...
  footerCopy: { flex: 1, color: cardColors.textSoft, fontSize: 11, fontWeight: "500" },
  footerUrl: { color: cardColors.lime, fontSize: 11, fontWeight: "700" },
});
