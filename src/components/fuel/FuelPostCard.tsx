...
const styles = StyleSheet.create({
  ...
  placeholderText: { fontFamily: strictlyType.bold,  color: strictlyColors.text, fontSize: 14, marginTop: 16 },
  body: { padding: 16 },
  ...
  context: { fontFamily: strictlyType.regular, color: strictlyColors.textSoft, fontSize: 11, marginTop: 4, textTransform: "capitalize" },
  score: { alignItems: "center", justifyContent: "center", width: 45, height: 45, borderRadius: 23, backgroundColor: strictlyColors.lime },
  scoreValue: { fontFamily: strictlyType.bold,  color: strictlyColors.onLime, fontSize: 16, lineHeight: 17 },
  scoreLabel: { fontFamily: strictlyType.semibold, fontSize: 11, letterSpacing: 1.1, color: strictlyColors.onLimeSoft },
