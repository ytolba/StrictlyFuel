...
const styles = StyleSheet.create({
  ...
  scoreLabel: { fontFamily: strictlyType.mono, fontSize: 6, letterSpacing: 0.6, color: strictlyColors.onLimeSoft },
  ...
  carbs: { fontFamily: strictlyType.sansMedium, fontWeight: "800", color: strictlyColors.text, fontSize: 26, marginTop: 7, marginBottom: 11 },
