...
const styles = StyleSheet.create({
  ...
  scoreValue: { fontFamily: strictlyType.sansMedium, fontWeight: "700", color: strictlyColors.onLime, fontSize: 16, lineHeight: 17 },
  scoreLabel: { fontFamily: strictlyType.mono, fontSize: 11, letterSpacing: 0.3, color: strictlyColors.onLimeSoft },
  mealName: { fontFamily: strictlyType.sansMedium, fontWeight: "700", color: strictlyColors.text, fontSize: 20, letterSpacing: -0.4, marginTop: 13 },
  carbs: { fontFamily: strictlyType.sansMedium, fontWeight: "700", color: strictlyColors.text, fontSize: 26, marginTop: 7, marginBottom: 11 },
