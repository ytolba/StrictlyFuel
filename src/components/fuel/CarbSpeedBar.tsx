...
const styles = StyleSheet.create({
  ...
  inlineValue: { fontFamily: strictlyType.sansMedium, fontWeight: "700", color: strictlyColors.text },
  ...
  rowLabel: { fontFamily: strictlyType.sansMedium, fontWeight: "700", color: strictlyColors.text, fontSize: 13 },
  rowValue: { fontFamily: strictlyType.sansMedium, fontWeight: "700", color: strictlyColors.text, fontSize: 14 },
  rowShare: { fontFamily: strictlyType.mono, fontWeight: "400", color: strictlyColors.textSoft, fontSize: 11 },
  rowTarget: { fontFamily: strictlyType.sans, color: strictlyColors.textSoft, fontSize: 11, marginTop: 4 },
  ...
  rowHint: { fontFamily: strictlyType.sans, color: strictlyColors.textSoft, fontSize: 11, lineHeight: 15, marginTop: 4 },
