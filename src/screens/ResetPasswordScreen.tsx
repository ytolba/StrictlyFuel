...
const styles = StyleSheet.create({
  ...
  kicker: { color: semanticColors.textMuted, fontFamily: strictlyType.mono, letterSpacing: 2, fontSize: 12, marginBottom: 12 },
  title: { color: strictlyColors.text, fontFamily: strictlyType.sans, fontWeight: "800", fontSize: 34, marginBottom: 10 },
  ...
  buttonText: { color: strictlyColors.ink, fontFamily: strictlyType.sans, fontWeight: "800", fontSize: 16 },
