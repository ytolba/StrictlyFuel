...
const styles = StyleSheet.create({
  ...
  kicker: { color: semanticColors.textMuted, fontFamily: strictlyType.semibold, letterSpacing: 1.1, fontSize: 12, marginBottom: 12 },
  title: { color: strictlyColors.text, fontFamily: strictlyType.bold,  fontSize: 34, marginBottom: 10 },
  subtitle: { color: semanticColors.textMuted, fontFamily: strictlyType.regular, fontSize: 16, lineHeight: 24, marginBottom: 28 },
  card: { backgroundColor: strictlyColors.surface, borderRadius: strictlyRadius.xlarge, padding: 20 },
  label: { color: semanticColors.textMuted, fontFamily: strictlyType.medium, fontSize: 13, marginBottom: 8, marginTop: 10 },
  ...
  buttonText: { color: strictlyColors.ink, fontFamily: strictlyType.bold,  fontSize: 16 },
  secondaryButton: { height: 48, alignItems: "center", justifyContent: "center", marginTop: 10 },
  secondaryButtonText: { color: strictlyColors.text, fontFamily: strictlyType.bold,  fontSize: 15 },
});
