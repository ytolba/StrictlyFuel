...
const styles = StyleSheet.create({
  ...
  sectionTitle: { fontFamily: strictlyType.sansMedium, fontWeight: "700", color: strictlyColors.text, fontSize: 19, marginTop: 28, marginBottom: 10 },
  ...
  actionCopy: { flex: 1 },
  actionTitle: { fontFamily: strictlyType.sansMedium, fontWeight: "700", color: strictlyColors.text, fontSize: 14 },
  actionTitlePrimary: { fontFamily: strictlyType.sansMedium, fontWeight: "700", color: strictlyColors.onLime, fontSize: 14 },
  ...
  intraEyebrow: { fontFamily: strictlyType.mono, fontSize: 11, letterSpacing: 0.3, color: strictlyColors.textSoft },
  intraValue: { fontFamily: strictlyType.sansMedium, fontWeight: "700", fontSize: 26, color: strictlyColors.text, marginTop: 10 },
  ...
  packItem: { flex: 1 },
  packLabel: { fontFamily: strictlyType.mono, color: strictlyColors.textSoft, fontSize: 11, letterSpacing: 0.3 },
  packValue: { fontFamily: strictlyType.sansMedium, fontWeight: "700", color: strictlyColors.text, fontSize: 20, marginTop: 3 },
  timelineTitle: { fontFamily: strictlyType.mono, color: strictlyColors.textSoft, fontSize: 11, letterSpacing: 0.3, marginTop: 17, marginBottom: 6 },
  timeline: { paddingLeft: 3 },
  timelinePoint: { minHeight: 38, flexDirection: "row", alignItems: "center", gap: 10 },
  timelineTime: { width: 36, fontFamily: strictlyType.mono, color: strictlyColors.textSoft, fontSize: 11 },
  timelineDot: { width: 9, height: 9, borderRadius: 5, backgroundColor: strictlyColors.lime },
  timelineGrams: { fontFamily: strictlyType.sansMedium, fontWeight: "700", color: strictlyColors.text, fontSize: 11 },

  disclaimer: { fontFamily: strictlyType.sans, color: strictlyColors.textSoft, fontSize: 11, lineHeight: 15, marginTop: 18 },
});
