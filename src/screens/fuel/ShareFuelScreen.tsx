...
const styles = StyleSheet.create({
  ...
  sectionTitle: { fontFamily: strictlyType.sansMedium, fontWeight: "700", color: strictlyColors.text, fontSize: 16, marginTop: 23, marginBottom: 10 },
  ...
  shareActionLabel: { fontFamily: strictlyType.sansMedium, fontWeight: "700", color: strictlyColors.text, fontSize: 11 },
  saveActionLabel: { color: strictlyColors.onLime },
  actionDim: { opacity: 0.5 },
  shareHint: { fontFamily: strictlyType.sans, color: strictlyColors.textSoft, fontSize: 11, lineHeight: 14, marginTop: 9 },
  ...
  sectionTitleInline: { fontFamily: strictlyType.sansMedium, fontWeight: "700", color: strictlyColors.text, fontSize: 16 },
  communityDetail: { fontFamily: strictlyType.sans, color: strictlyColors.textSoft, fontSize: 11, marginTop: 2 },
  ...
  controlEyebrow: { fontFamily: strictlyType.mono, color: strictlyColors.textSoft, fontSize: 11, letterSpacing: 0.3, marginTop: 18, marginBottom: 8 },
  ...
  controlText: { fontFamily: strictlyType.sans, color: strictlyColors.textSoft, fontSize: 11, marginTop: 3 },
  ...
  privacyText: { flex: 1, fontFamily: strictlyType.sans, color: strictlyColors.text, fontSize: 11, lineHeight: 15 },
  ...
  publishText: { fontFamily: strictlyType.sansMedium, fontWeight: "700", color: strictlyColors.onLime },
