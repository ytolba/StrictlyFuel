...
const styles = StyleSheet.create({
  ...
  lockedTitle: { marginTop: 19, fontFamily: strictlyType.sansMedium, fontWeight: "700", color: strictlyColors.text, fontSize: 25, lineHeight: 30, letterSpacing: -0.6 },
  lockedText: { marginTop: 9, fontFamily: strictlyType.sans, color: strictlyColors.textSoft, fontSize: 13, lineHeight: 20 },
  benefits: { gap: 11, marginTop: 20, paddingTop: 17, borderTopWidth: 1, borderTopColor: strictlyColors.border },
  benefit: { flexDirection: "row", alignItems: "center", gap: 9 }, benefitText: { flex: 1, fontFamily: strictlyType.sansMedium, color: strictlyColors.text, fontSize: 12 },
  unlock: { height: 54, marginTop: 21, borderRadius: strictlyRadius.medium, backgroundColor: strictlyColors.lime, flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 8 }, unlockText: { fontFamily: strictlyType.sansMedium, fontWeight: "700", color: strictlyColors.onLime, fontSize: 13 },
  sessionPicker: { gap: 7, marginTop: 15 }, sessionPickerLabel: { fontFamily: strictlyType.mono, color: strictlyColors.textSoft, fontSize: 11, letterSpacing: 0.3, marginBottom: 2 },
  ...
  sessionOptionCopy: { flex: 1, minWidth: 0 }, sessionOptionTitle: { fontFamily: strictlyType.sansMedium, fontWeight: "700", color: strictlyColors.text, fontSize: 12 }, sessionOptionTitleActive: { color: strictlyColors.onLime }, sessionOptionMeta: { marginTop: 3, fontFamily: strictlyType.sans, color: strictlyColors.textSoft, fontSize: 11 }, sessionOptionMetaActive: { color: strictlyColors.onLimeSoft },
  ...
  actualEyebrow: { fontFamily: strictlyType.mono, color: strictlyColors.textSoft, fontSize: 11, letterSpacing: 0.3 }, actualTitle: { fontFamily: strictlyType.sansMedium, fontWeight: "700", color: strictlyColors.text, fontSize: 15, lineHeight: 20, marginTop: 4, textTransform: "capitalize" },
  actualMetrics: { flexDirection: "row", flexWrap: "wrap", gap: 6, marginTop: 8 }, actualMetric: { paddingHorizontal: 7, paddingVertical: 4, borderRadius: strictlyRadius.pill, overflow: "hidden", backgroundColor: strictlyColors.cream, fontFamily: strictlyType.mono, color: strictlyColors.text, fontSize: 11 }, sourceNote: { marginTop: 9, fontFamily: strictlyType.sans, color: strictlyColors.textSoft, fontSize: 11, lineHeight: 14 },
  effortBlock: { padding: 14, marginTop: 9, borderRadius: strictlyRadius.large, backgroundColor: strictlyColors.surface }, effortHeading: { gap: 3, marginBottom: 10 }, effortTitle: { fontFamily: strictlyType.sansMedium, fontWeight: "700", color: strictlyColors.text, fontSize: 13 }, effortHelp: { fontFamily: strictlyType.sans, color: strictlyColors.textSoft, fontSize: 11, lineHeight: 14 },
  effortSegment: { flexDirection: "row", gap: 6 }, effortOption: { flex: 1, height: 39, borderRadius: strictlyRadius.small, backgroundColor: strictlyColors.surfaceMuted, alignItems: "center", justifyContent: "center" }, effortOptionActive: { backgroundColor: strictlyColors.lime }, effortOptionText: { fontFamily: strictlyType.sansMedium, color: strictlyColors.textSoft, fontSize: 11, textTransform: "capitalize" }, effortOptionTextActive: { color: strictlyColors.onLime, fontWeight: "700" },
  connectPrompt: { minHeight: 62, padding: 13, marginTop: 9, flexDirection: "row", alignItems: "center", gap: 10, borderRadius: strictlyRadius.large, backgroundColor: strictlyColors.cream }, connectPromptCopy: { flex: 1 }, connectPromptTitle: { fontFamily: strictlyType.sansMedium, fontWeight: "700", color: strictlyColors.text, fontSize: 11 }, connectPromptText: { marginTop: 3, fontFamily: strictlyType.sans, color: strictlyColors.textSoft, fontSize: 11 },
  question: { marginTop: 24, marginBottom: 10, fontFamily: strictlyType.sansMedium, fontWeight: "700", color: strictlyColors.text, fontSize: 17 }, windowList: { gap: 8 },
  ...
  windowCopy: { flex: 1 }, windowLabel: { fontFamily: strictlyType.sansMedium, fontWeight: "700", color: strictlyColors.text, fontSize: 13 }, windowLabelActive: { color: strictlyColors.onLime }, windowDetail: { fontFamily: strictlyType.sans, color: strictlyColors.textSoft, fontSize: 11, marginTop: 2 }, windowDetailActive: { color: strictlyColors.onLimeSoft },
  targetCard: { padding: 18, marginTop: 16, borderRadius: strictlyRadius.large, backgroundColor: strictlyColors.ink, borderWidth: 1, borderColor: strictlyColors.border }, targetEyebrow: { fontFamily: strictlyType.mono, color: strictlyColors.inverseTextSoft, fontSize: 11, letterSpacing: 0.3 }, targetHeading: { marginTop: 7, fontFamily: strictlyType.sansMedium, fontWeight: "700", color: strictlyColors.inverseText, fontSize: 17 },
  targets: { flexDirection: "row", alignItems: "center", gap: 16, marginTop: 14 }, targetColumn: { flex: 1 }, targetValue: { fontFamily: strictlyType.sansMedium, fontWeight: "700", color: strictlyColors.inverseText, fontSize: 30 }, targetLabel: { fontFamily: strictlyType.mono, color: strictlyColors.inverseTextSoft, fontSize: 11, marginTop: 2 }, targetRange: { marginTop: 5, fontFamily: strictlyType.sans, color: strictlyColors.inverseTextSoft, fontSize: 11 }, targetDivider: { width: 1, height: 54, backgroundColor: strictlyColors.overlayLine },
  timing: { fontFamily: strictlyType.sansMedium, fontWeight: "700", color: strictlyColors.lime, fontSize: 12, marginTop: 17 }, rationale: { fontFamily: strictlyType.sans, color: strictlyColors.inverseTextSoft, fontSize: 11, lineHeight: 17, marginTop: 6 }, healthContextNote: { fontFamily: strictlyType.sans, color: strictlyColors.textSoft, fontSize: 11, lineHeight: 14, marginTop: 7, paddingHorizontal: 3 },
  caution: { flexDirection: "row", gap: 9, padding: 13, marginTop: 10, borderRadius: strictlyRadius.medium, backgroundColor: strictlyColors.dangerSurface }, cautionText: { flex: 1, fontFamily: strictlyType.sans, color: strictlyColors.text, fontSize: 11, lineHeight: 16 },
  sectionHead: { flexDirection: "row", alignItems: "baseline", justifyContent: "space-between", gap: 10, marginTop: 28, marginBottom: 11 }, sectionTitle: { flex: 1, fontFamily: strictlyType.sansMedium, fontWeight: "700", color: strictlyColors.text, fontSize: 19 }, sectionMeta: { fontFamily: strictlyType.mono, color: strictlyColors.textSoft, fontSize: 11 },
  mealCard: { padding: 16, marginBottom: 10, borderRadius: strictlyRadius.large, backgroundColor: strictlyColors.surface, borderWidth: 1, borderColor: strictlyColors.border }, bestCard: { backgroundColor: strictlyColors.surfaceMuted, borderColor: strictlyColors.borderStrong }, mealHead: { flexDirection: "row", alignItems: "center", gap: 12 }, mealCopy: { flex: 1, minWidth: 0 }, mealEyebrow: { fontFamily: strictlyType.mono, color: strictlyColors.textSoft, fontSize: 11, letterSpacing: 0.3 }, mealName: { fontFamily: strictlyType.sansMedium, fontWeight: "700", color: strictlyColors.text, fontSize: 18, lineHeight: 22, marginTop: 4 },
  score: { width: 54, height: 54, flexShrink: 0, borderRadius: 27, backgroundColor: strictlyColors.good, alignItems: "center", justifyContent: "center" }, scoreValue: { fontFamily: strictlyType.sansMedium, fontWeight: "700", color: strictlyColors.onLime, fontSize: 17 }, scoreLabel: { fontFamily: strictlyType.mono, color: strictlyColors.onLime, fontSize: 11 }, description: { fontFamily: strictlyType.sans, color: strictlyColors.textSoft, fontSize: 11, lineHeight: 17, marginTop: 10 },
  macros: { flexDirection: "row", flexWrap: "wrap", gap: 8, marginTop: 12 }, macroStrong: { fontFamily: strictlyType.sansMedium, fontWeight: "700", color: strictlyColors.text, fontSize: 11 }, macro: { fontFamily: strictlyType.mono, color: strictlyColors.textSoft, fontSize: 11 },
  ingredients: { marginTop: 12, borderTopWidth: 1, borderTopColor: strictlyColors.border, paddingTop: 8 }, ingredient: { minHeight: 34, flexDirection: "row", alignItems: "center", gap: 8 }, emoji: { width: 20, fontSize: 14 }, ingredientName: { flex: 1, fontFamily: strictlyType.sans, color: strictlyColors.text, fontSize: 11 }, portion: { fontFamily: strictlyType.sansMedium, fontWeight: "700", color: strictlyColors.text, fontSize: 11 },
  scaled: { flexDirection: "row", gap: 7, padding: 10, marginTop: 8, borderRadius: strictlyRadius.small, backgroundColor: strictlyColors.cream }, scaledText: { flex: 1, fontFamily: strictlyType.sans, color: strictlyColors.text, fontSize: 11, lineHeight: 14 }, recipe: { gap: 9, marginTop: 12 }, step: { flexDirection: "row", gap: 9 }, stepNumber: { width: 20, height: 20, borderRadius: 10, backgroundColor: strictlyColors.cream, textAlign: "center", lineHeight: 20, fontFamily: strictlyType.mono, color: strictlyColors.text, fontSize: 11 }, stepText: { flex: 1, fontFamily: strictlyType.sans, color: strictlyColors.text, fontSize: 11, lineHeight: 16 },
  recipeButton: { height: 46, marginTop: 13, borderRadius: strictlyRadius.medium, backgroundColor: strictlyColors.surfaceMuted, flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 7 }, recipeButtonBest: { backgroundColor: strictlyColors.lime }, recipeButtonText: { fontFamily: strictlyType.sansMedium, fontWeight: "700", color: strictlyColors.text, fontSize: 11 }, recipeButtonTextBest: { color: strictlyColors.onLime },
  emptyCard: { padding: 20, borderRadius: strictlyRadius.large, backgroundColor: strictlyColors.surface, borderWidth: 1, borderColor: strictlyColors.border }, emptyIcon: { width: 48, height: 48, borderRadius: 16, backgroundColor: strictlyColors.cream, alignItems: "center", justifyContent: "center", marginBottom: 16 }, emptyTitle: { fontFamily: strictlyType.sansMedium, fontWeight: "700", color: strictlyColors.text, fontSize: 17 }, emptyText: { fontFamily: strictlyType.sans, color: strictlyColors.textSoft, fontSize: 11, lineHeight: 17, marginTop: 6 }, emptyAction: { height: 45, flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 7, marginTop: 15, borderRadius: strictlyRadius.medium, backgroundColor: strictlyColors.lime }, emptyActionText: { fontFamily: strictlyType.sansMedium, fontWeight: "700", color: strictlyColors.onLime, fontSize: 11 },
  hydration: { flexDirection: "row", gap: 9, padding: 14, marginTop: 12, borderRadius: strictlyRadius.medium, backgroundColor: strictlyColors.cream }, hydrationText: { flex: 1, fontFamily: strictlyType.sans, color: strictlyColors.text, fontSize: 11, lineHeight: 16 }, disclaimer: { fontFamily: strictlyType.sans, color: strictlyColors.textSoft, fontSize: 11, lineHeight: 14, marginTop: 13 },
});
