...
const styles = StyleSheet.create({
  ...
  healthMark: { width: 42, height: 42, borderRadius: 14, alignItems: "center", justifyContent: "center", backgroundColor: "#E64A55" }, healthCopy: { flex: 1 },
  healthTitle: { fontFamily: strictlyType.sansMedium, fontWeight: "700", color: strictlyColors.text, fontSize: 14 }, healthText: { marginTop: 3, fontFamily: strictlyType.sans, color: strictlyColors.textSoft, fontSize: 11, lineHeight: 15 },
  divider: { height: 1, backgroundColor: strictlyColors.border, marginVertical: 30 }, privacy: { flexDirection: "row", gap: 10, padding: 14, borderRadius: strictlyRadius.large, backgroundColor: strictlyColors.cream }, privacyText: { flex: 1, fontFamily: strictlyType.sans, color: strictlyColors.text, fontSize: 11, lineHeight: 16 }, save: { height: 56, alignItems: "center", justifyContent: "center", marginTop: 16, borderRadius: strictlyRadius.medium, backgroundColor: strictlyColors.lime }, saveText: { fontFamily: strictlyType.sansMedium, fontWeight: "700", color: strictlyColors.onLime, fontSize: 13 }, signOut: { height: 50, alignItems: "center", justifyContent: "center" }, signOutText: { fontFamily: strictlyType.sansMedium, fontWeight: "700", color: strictlyColors.danger, fontSize: 12 },
});
