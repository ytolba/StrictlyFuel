...
const styles = StyleSheet.create({
  ...
  reshuffleText: { fontFamily: strictlyType.sansMedium, fontWeight: "700", color: strictlyColors.onLime, fontSize: 14 },
  reshuffleMeta: { fontFamily: strictlyType.sans, color: strictlyColors.onLimeSoft, fontSize: 11, marginTop: 2 },
  ...
  cardCopy: { flex: 1 },
  cardEyebrow: { fontFamily: strictlyType.mono, color: strictlyColors.textSoft, fontSize: 11, letterSpacing: 0.3 },
  cardTitle: { fontFamily: strictlyType.sansMedium, fontWeight: "700", color: strictlyColors.text, fontSize: 18, lineHeight: 22, marginTop: 4 },
  score: { width: 50, height: 50, borderRadius: 25, alignItems: "center", justifyContent: "center" },
  scoreValue: { fontFamily: strictlyType.sansMedium, fontWeight: "700", color: strictlyColors.onLime, fontSize: 16 },
  scoreLabel: { fontFamily: strictlyType.mono, color: strictlyColors.onLimeSoft, fontSize: 11 },
  band: { fontFamily: strictlyType.mono, fontSize: 11, letterSpacing: 0.3, textTransform: "uppercase", marginTop: 10 },

  macroRow: { flexDirection: "row", alignItems: "baseline", justifyContent: "space-between", gap: 10, marginTop: 10, marginBottom: 10 },
  carbs: { fontFamily: strictlyType.sansMedium, fontWeight: "700", color: strictlyColors.text, fontSize: 25 },
  carbsUnit: { fontFamily: strictlyType.sans, fontWeight: "400", color: strictlyColors.textSoft, fontSize: 11 },
  macro: { fontFamily: strictlyType.mono, color: strictlyColors.textSoft, fontSize: 11 },
  ...
  timingCopy: { flex: 1 },
  timingLabel: { fontFamily: strictlyType.mono, color: strictlyColors.textSoft, fontSize: 11, letterSpacing: 0.3 },
  ...
  useText: { fontFamily: strictlyType.sansMedium, fontWeight: "700", color: strictlyColors.lime, fontSize: 13 },
  useTextBest: { color: strictlyColors.onLime },

  moreTitle: { fontFamily: strictlyType.sansMedium, fontWeight: "700", color: strictlyColors.text, fontSize: 19, marginTop: 18, marginBottom: 10 },
  ...
  emptyTitle: { fontFamily: strictlyType.sansMedium, fontWeight: "700", color: strictlyColors.text, fontSize: 16 },
  ...
  emptyActionText: { fontFamily: strictlyType.sansMedium, fontWeight: "700", color: strictlyColors.onLime, fontSize: 13 },

  note: { fontFamily: strictlyType.sans, color: strictlyColors.textSoft, fontSize: 11, lineHeight: 15, marginTop: 8 },
});
