...
const styles = StyleSheet.create({
  ...
  usageLink: { fontFamily: strictlyType.sansMedium, fontWeight: "700", color: strictlyColors.accentText, fontSize: 11 },
  ...
  heroTitle: { fontFamily: strictlyType.sansMedium, fontWeight: "700", fontSize: 25, color: strictlyColors.text, marginTop: 18 },
  ...
  angleCopy: { flex: 1 },
  angleTitle: { fontFamily: strictlyType.sansMedium, fontWeight: "700", color: strictlyColors.text, fontSize: 13 },
  angleText: { marginTop: 4, fontFamily: strictlyType.sans, color: strictlyColors.textSoft, fontSize: 11, lineHeight: 15 },
  ...
  primaryText: { fontFamily: strictlyType.sansMedium, fontWeight: "700", color: strictlyColors.onLime },
  ...
  captureOptionTitle: { marginTop: 7, fontFamily: strictlyType.sansMedium, fontWeight: "700", color: strictlyColors.text, fontSize: 12 },
  captureOptionText: { marginTop: 3, fontFamily: strictlyType.sans, color: strictlyColors.textSoft, fontSize: 11 },
  ...
  truthStrong: { fontFamily: strictlyType.sansMedium, fontWeight: "700", color: strictlyColors.text },
  ...
  estimateLabel: { fontFamily: strictlyType.mono, color: strictlyColors.textSoft, fontSize: 11, letterSpacing: 0.3 },
  estimateName: { fontFamily: strictlyType.sansMedium, fontWeight: "700", color: strictlyColors.text, fontSize: 21, marginTop: 6, maxWidth: 210 },
  estimateCarbs: { fontFamily: strictlyType.sansMedium, fontWeight: "700", color: strictlyColors.text, fontSize: 25 },
  estimateUnit: { fontFamily: strictlyType.sans, fontWeight: "400", color: strictlyColors.textSoft, fontSize: 11 },
  ...
  itemMeta: { fontFamily: strictlyType.sans, color: strictlyColors.textSoft, fontSize: 11, marginTop: 3 },
  sourceMeta: { fontFamily: strictlyType.mono, color: strictlyColors.muted, fontSize: 11, marginTop: 4, textTransform: "uppercase" },
  ...
  editFoodsText: { fontFamily: strictlyType.sansMedium, fontWeight: "700", color: strictlyColors.text, fontSize: 11 },
  ...
  warningText: { flex: 1, fontFamily: strictlyType.sans, color: strictlyColors.text, fontSize: 11, lineHeight: 15 },
  ...
  followupCopy: { flex: 1 },
  followupLabel: { fontFamily: strictlyType.mono, color: strictlyColors.clay, fontSize: 11, letterSpacing: 0.3, marginBottom: 4 },
  ...
  followupOptionText: { fontFamily: strictlyType.sansMedium, color: strictlyColors.text, fontSize: 11, fontWeight: "700" },
  ...
  refine: { alignItems: "center", padding: 12, backgroundColor: strictlyColors.ink, borderWidth: 1, borderColor: strictlyColors.border, borderRadius: strictlyRadius.medium, marginTop: 8 },
  ...
  refineNote: { marginTop: 7, fontFamily: strictlyType.sans, color: strictlyColors.textSoft, fontSize: 11, textAlign: "center" },
  ...
  confidenceImprovedText: { fontFamily: strictlyType.sansMedium, color: strictlyColors.text, fontSize: 11, fontWeight: "700" },
  ...
  estimateAcceptedText: { flex: 1, fontFamily: strictlyType.sans, color: strictlyColors.textSoft, fontSize: 11, lineHeight: 15 },
  disabled: { opacity: 0.4 },
  disclaimer: { fontFamily: strictlyType.sans, color: strictlyColors.textSoft, fontSize: 11, lineHeight: 14, marginTop: 11 },
});
