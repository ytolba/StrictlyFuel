...
const styles = StyleSheet.create({
  ...
  estimateName: { fontFamily: strictlyType.bold,  color: strictlyColors.text, fontSize: 21, marginTop: 6, maxWidth: 210 },
  estimateCarbs: { fontFamily: strictlyType.bold,  color: strictlyColors.text, fontSize: 25 },
  ...
  itemMeta: { fontFamily: strictlyType.regular, color: strictlyColors.textSoft, fontSize: 11, marginTop: 3 },
  sourceMeta: { fontFamily: strictlyType.semibold, color: strictlyColors.muted, fontSize: 11, marginTop: 4, textTransform: "uppercase" },
  ...
  contextInput: { minHeight: 46, backgroundColor: strictlyColors.surface, borderWidth: 1, borderColor: strictlyColors.borderStrong, borderRadius: strictlyRadius.medium, paddingHorizontal: 12, marginTop: 9, fontFamily: strictlyType.regular, color: strictlyColors.text },
  ...
  refineText: { fontFamily: strictlyType.bold,  color: strictlyColors.white, fontSize: 12 },
  useEstimate: { alignItems: "center", padding: 11, marginTop: 6 },
  useEstimateText: { fontFamily: strictlyType.bold,  color: strictlyColors.text, fontSize: 11 },
