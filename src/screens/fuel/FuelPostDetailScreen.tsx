...
const styles = StyleSheet.create({
  ...
  ingredientName: { fontFamily: strictlyType.medium, color: strictlyColors.text, fontSize: 12 },
  ingredientAmount: { fontFamily: strictlyType.semibold, color: strictlyColors.textSoft, fontSize: 11 },
  ...
  exampleNoteText: { flex: 1, fontFamily: strictlyType.regular, color: strictlyColors.text, fontSize: 11, lineHeight: 15 },
  usefulValue: { fontFamily: strictlyType.bold,  color: strictlyColors.text, fontSize: 16 },
  usefulLabel: { fontFamily: strictlyType.regular, color: strictlyColors.textSoft, fontSize: 11 },
  ...
  copyText: { fontFamily: strictlyType.bold,  color: strictlyColors.onLime },
  ...
  saveText: { fontFamily: strictlyType.bold,  color: strictlyColors.text, fontSize: 12 },
  ...
  safetyText: { fontFamily: strictlyType.medium, color: strictlyColors.textSoft, fontSize: 11 },
