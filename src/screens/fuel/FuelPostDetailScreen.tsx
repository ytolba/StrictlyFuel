...
const styles = StyleSheet.create({
  ...
  avatarText: { fontFamily: strictlyType.sansMedium, fontWeight: "700", color: strictlyColors.lime },
  username: { fontFamily: strictlyType.sansMedium, fontWeight: "700", color: strictlyColors.text, fontSize: 12 },
  context: { fontFamily: strictlyType.sans, color: strictlyColors.textSoft, fontSize: 11, marginTop: 3, textTransform: "capitalize" },
  example: { paddingHorizontal: 7, paddingVertical: 4, overflow: "hidden", borderRadius: strictlyRadius.pill, backgroundColor: strictlyColors.cream, fontFamily: strictlyType.mono, color: strictlyColors.accentText, fontSize: 11, letterSpacing: 0.3 },
  name: { fontFamily: strictlyType.sansMedium, fontWeight: "700", color: strictlyColors.text, fontSize: 29, letterSpacing: -0.8, marginTop: 19 },
  caption: { fontFamily: strictlyType.sans, color: strictlyColors.textSoft, fontSize: 13, lineHeight: 20, marginTop: 7 },
  fuel: { padding: 17, backgroundColor: strictlyColors.ink, borderWidth: 1, borderColor: strictlyColors.border, borderRadius: strictlyRadius.large, marginTop: 16 },
  fuelTop: { flexDirection: "row", justifyContent: "space-between", alignItems: "center", marginBottom: 13 },
  fuelLabel: { fontFamily: strictlyType.mono, color: strictlyColors.sage, fontSize: 11, letterSpacing: 0.3 },
  carbs: { fontFamily: strictlyType.sansMedium, fontWeight: "700", color: strictlyColors.white, fontSize: 35, marginTop: 2 },
  score: { width: 66, height: 66, borderRadius: 33, backgroundColor: strictlyColors.lime, alignItems: "center", justifyContent: "center" },
  scoreValue: { fontFamily: strictlyType.sansMedium, fontWeight: "700", color: strictlyColors.onLime, fontSize: 23, lineHeight: 25 },
  scoreLabel: { fontFamily: strictlyType.mono, color: strictlyColors.onLime, fontSize: 11 },
  macros: { flexDirection: "row", gap: 8, marginTop: 13 },
  macro: { fontFamily: strictlyType.sans, color: strictlyColors.inverseTextSoft, fontSize: 11 },
  sectionTitle: { fontFamily: strictlyType.sansMedium, fontWeight: "700", color: strictlyColors.text, fontSize: 18, marginTop: 23, marginBottom: 9 },
  ...
  ingredientAmount: { fontFamily: strictlyType.mono, color: strictlyColors.textSoft, fontSize: 11 },
  ...
  exampleNoteText: { flex: 1, fontFamily: strictlyType.sans, color: strictlyColors.text, fontSize: 11, lineHeight: 15 },
  usefulValue: { fontFamily: strictlyType.sansMedium, fontWeight: "700", color: strictlyColors.text, fontSize: 16 },
  usefulLabel: { fontFamily: strictlyType.sans, color: strictlyColors.textSoft, fontSize: 11 },
  ...
  copyText: { fontFamily: strictlyType.sansMedium, fontWeight: "700", color: strictlyColors.onLime },
  ...
  safetyText: { fontFamily: strictlyType.sansMedium, color: strictlyColors.textSoft, fontSize: 11 },
