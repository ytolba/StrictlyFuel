...
const styles = StyleSheet.create({
  ...
  username: { fontFamily: strictlyType.semibold, color: strictlyColors.textSoft, fontSize: 11, marginTop: 4 },
  ...
  statValue: { fontFamily: strictlyType.bold,  color: strictlyColors.text, fontSize: 20 },
  statLabel: { fontFamily: strictlyType.regular, color: strictlyColors.textSoft, fontSize: 11, marginTop: 3 },
  ...
  planCopy: { flex: 1 },
  planTitle: { fontFamily: strictlyType.bold,  color: strictlyColors.onLime, fontSize: 15 },
  planText: { fontFamily: strictlyType.regular, color: strictlyColors.onLimeSoft, fontSize: 11, lineHeight: 16, marginTop: 3 },
  ...
  rowCopy: { flex: 1 },
  rowText: { fontFamily: strictlyType.bold,  color: strictlyColors.text, fontSize: 13 },
  rowTextDanger: { color: strictlyColors.danger },
  rowDetail: { fontFamily: strictlyType.regular, color: strictlyColors.textSoft, fontSize: 11, lineHeight: 15, marginTop: 3 },
  ...
  appearanceTitle: { fontFamily: strictlyType.bold,  color: strictlyColors.text, fontSize: 13 },
  appearanceText: { fontFamily: strictlyType.regular, color: strictlyColors.textSoft, fontSize: 11, lineHeight: 15, marginTop: 3 },
  ...
  appearanceChoiceText: { fontFamily: strictlyType.bold,  color: strictlyColors.textSoft, fontSize: 11, textTransform: "capitalize" },
  appearanceChoiceTextActive: { color: strictlyColors.onLime, fontFamily: strictlyType.bold },
  ...
  deletingText: { fontFamily: strictlyType.bold,  color: strictlyColors.danger, fontSize: 12 },
  ...
  principleTitle: { fontFamily: strictlyType.bold,  color: strictlyColors.text, fontSize: 13 },
  principleText: { fontFamily: strictlyType.regular, color: strictlyColors.textSoft, fontSize: 11, lineHeight: 16, marginTop: 3 },
});
