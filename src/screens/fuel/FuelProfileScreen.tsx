...
const styles = StyleSheet.create({
  ...
  avatarText: { fontFamily: strictlyType.sansMedium, fontWeight: "700", color: strictlyColors.lime, fontSize: 29 },
  name: { fontFamily: strictlyType.sansMedium, fontWeight: "700", color: strictlyColors.text, fontSize: 25, marginTop: 13 },
  username: { fontFamily: strictlyType.mono, color: strictlyColors.textSoft, fontSize: 11, marginTop: 4 },
  ...
  statValue: { fontFamily: strictlyType.sansMedium, fontWeight: "700", color: strictlyColors.text, fontSize: 20 },
  statLabel: { fontFamily: strictlyType.sans, color: strictlyColors.textSoft, fontSize: 11, marginTop: 3 },
  ...
  planCopy: { flex: 1 },
  planTitle: { fontFamily: strictlyType.sansMedium, fontWeight: "700", color: strictlyColors.onLime, fontSize: 15 },
  ...
  rowDetail: { fontFamily: strictlyType.sans, color: strictlyColors.textSoft, fontSize: 11, lineHeight: 15, marginTop: 3 },
  ...
  appearanceTitle: { fontFamily: strictlyType.sansMedium, fontWeight: "700", color: strictlyColors.text, fontSize: 13 },
  appearanceText: { fontFamily: strictlyType.sans, color: strictlyColors.textSoft, fontSize: 11, lineHeight: 15, marginTop: 3 },
  ...
  appearanceChoiceText: { fontFamily: strictlyType.sansMedium, fontWeight: "700", color: strictlyColors.textSoft, fontSize: 11, textTransform: "capitalize" },
  appearanceChoiceTextActive: { color: strictlyColors.onLime, fontWeight: "700" },
  ...
  principleTitle: { fontFamily: strictlyType.sansMedium, fontWeight: "700", color: strictlyColors.text, fontSize: 13 },
