...
const styles = StyleSheet.create({
  ...
  title: { fontFamily: strictlyType.sansMedium, fontWeight: "700", color: strictlyColors.text, fontSize: 32, letterSpacing: -1.1, marginTop: 5 },
  ...
  utilityText: { flex: 1, fontFamily: strictlyType.sans, color: strictlyColors.textSoft, fontSize: 11, lineHeight: 15 },
  utilityStrong: { fontFamily: strictlyType.sansMedium, fontWeight: "700", color: strictlyColors.text },
  resultCount: { fontFamily: strictlyType.mono, color: strictlyColors.textSoft, fontSize: 11, letterSpacing: 0.3, marginBottom: 10 },
  empty: { alignItems: "center", padding: 30 },
  emptyTitle: { fontFamily: strictlyType.sansMedium, fontWeight: "700", color: strictlyColors.text, fontSize: 17 },
