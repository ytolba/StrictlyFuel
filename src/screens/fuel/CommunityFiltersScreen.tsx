...
const styles = StyleSheet.create({
  ...
  choiceText: { fontFamily: strictlyType.sansMedium, color: strictlyColors.ink, fontSize: 11 },
  ...
  toggleText: { fontFamily: strictlyType.sansMedium, color: strictlyColors.ink, fontSize: 11 },
  ...
  applyText: { fontFamily: strictlyType.sansMedium, fontWeight: "900", color: strictlyColors.ink },
