...
const styles = StyleSheet.create({
  intro: { fontFamily: strictlyType.regular, color: strictlyColors.textSoft, fontSize: 14, lineHeight: 21, marginBottom: 16 },
  ...
  choiceTitle: { fontFamily: strictlyType.bold,  color: strictlyColors.text, fontSize: 16 }, choiceText: { fontFamily: strictlyType.regular, color: strictlyColors.textSoft, fontSize: 11, lineHeight: 16, marginTop: 4 },
  cameraWrap: { height: 390, overflow: "hidden", borderRadius: strictlyRadius.large, backgroundColor: strictlyColors.ink }, camera: { flex: 1 },
  scanFrame: { position: "absolute", left: 34, right: 34, top: 112, height: 128, borderRadius: 18, borderWidth: 3, borderColor: strictlyColors.lime }, cameraHint: { position: "absolute", bottom: 22, alignSelf: "center", color: strictlyColors.white, fontFamily: strictlyType.medium, fontSize: 12 },
  ...
  barcodeValue: { fontFamily: strictlyType.semibold, color: strictlyColors.text, fontSize: 11, letterSpacing: 1.1 },
  loadingNote: { maxWidth: 270, fontFamily: strictlyType.regular, color: strictlyColors.textSoft, fontSize: 11, lineHeight: 17, textAlign: "center" },
  notFoundTitle: { fontFamily: strictlyType.bold,  color: strictlyColors.text, fontSize: 18 }, notFoundText: { fontFamily: strictlyType.regular, color: strictlyColors.textSoft, fontSize: 12, lineHeight: 18, marginTop: 6 },
  primary: { minHeight: 54, paddingHorizontal: 18, borderRadius: strictlyRadius.medium, backgroundColor: strictlyColors.lime, flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 8, marginTop: 15 }, primaryText: { fontFamily: strictlyType.bold,  color: strictlyColors.onLime, fontSize: 13 },
  tryAgain: { alignItems: "center", padding: 13 }, tryAgainText: { fontFamily: strictlyType.bold,  color: strictlyColors.text, fontSize: 12 },
  manual: { marginTop: 18 }, fieldLabel: { fontFamily: strictlyType.semibold, color: strictlyColors.textSoft, fontSize: 11, letterSpacing: 1.1, marginTop: 16, marginBottom: 7 }, manualRow: { flexDirection: "row", gap: 8 },
  manualInput: { flex: 1, height: 52, borderRadius: strictlyRadius.medium, backgroundColor: strictlyColors.surface, borderWidth: 1, borderColor: strictlyColors.border, paddingHorizontal: 14, fontFamily: strictlyType.medium, color: strictlyColors.text }, go: { width: 52, height: 52, borderRadius: strictlyRadius.medium, backgroundColor: strictlyColors.lime, alignItems: "center", justifyContent: "center" },
  labelHero: { padding: 26, alignItems: "center", backgroundColor: strictlyColors.surface, borderRadius: strictlyRadius.large, borderWidth: 1, borderColor: strictlyColors.border }, labelTitle: { fontFamily: strictlyType.bold,  color: strictlyColors.text, fontSize: 22, marginTop: 13 }, labelText: { fontFamily: strictlyType.regular, color: strictlyColors.textSoft, fontSize: 12, lineHeight: 18, textAlign: "center", marginTop: 7 },
  photo: { width: "100%", height: 230, borderRadius: strictlyRadius.large, backgroundColor: strictlyColors.surfaceMuted }, form: { marginTop: 12 }, review: { flexDirection: "row", gap: 9, padding: 13, backgroundColor: strictlyColors.cream, borderRadius: strictlyRadius.medium }, reviewText: { flex: 1, fontFamily: strictlyType.regular, color: strictlyColors.text, fontSize: 11, lineHeight: 16 },
  textField: { minHeight: 50, backgroundColor: strictlyColors.surface, borderRadius: strictlyRadius.medium, borderWidth: 1, borderColor: strictlyColors.border, paddingHorizontal: 13, marginBottom: 8, color: strictlyColors.text, fontFamily: strictlyType.regular }, ingredients: { minHeight: 110, paddingTop: 13, textAlignVertical: "top" },
  numericGrid: { flexDirection: "row", flexWrap: "wrap", gap: 8 }, numericField: { width: "48%" }, numberLabel: { fontFamily: strictlyType.regular, color: strictlyColors.textSoft, fontSize: 11, marginBottom: 5 }, numberInputWrap: { height: 48, flexDirection: "row", alignItems: "center", gap: 5, backgroundColor: strictlyColors.surface, borderRadius: strictlyRadius.medium, borderWidth: 1, borderColor: strictlyColors.border, paddingHorizontal: 11 }, numberInput: { flex: 1, color: strictlyColors.text, fontFamily: strictlyType.bold,  fontSize: 15 }, unit: { fontFamily: strictlyType.semibold, color: strictlyColors.textSoft, fontSize: 11 },
  speedRow: { flexDirection: "row", gap: 7 }, speed: { flex: 1, height: 43, alignItems: "center", justifyContent: "center", borderRadius: strictlyRadius.pill, backgroundColor: strictlyColors.surface, borderWidth: 1, borderColor: strictlyColors.border }, speedActive: { backgroundColor: strictlyColors.ink, borderColor: strictlyColors.ink }, speedText: { fontFamily: strictlyType.medium, color: strictlyColors.textSoft, textTransform: "capitalize", fontSize: 12 }, speedTextActive: { color: strictlyColors.lime, fontFamily: strictlyType.bold }, reason: { fontFamily: strictlyType.regular, color: strictlyColors.textSoft, fontSize: 11, lineHeight: 15, marginTop: 8 }, retake: { alignItems: "center", padding: 15 },
});
