...
const styles = StyleSheet.create({ empty: { padding: 30, alignItems: "center" }, title: { fontFamily: strictlyType.sansMedium, fontWeight: "700", color: strictlyColors.text, fontSize: 17 }, text: { fontFamily: strictlyType.sans, color: strictlyColors.textSoft, fontSize: 11, lineHeight: 17, textAlign: "center", marginTop: 6 } });
