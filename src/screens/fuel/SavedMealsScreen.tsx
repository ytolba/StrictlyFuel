...
const styles = StyleSheet.create({ empty: { padding: 30, alignItems: "center" }, title: { fontFamily: strictlyType.bold,  color: strictlyColors.text, fontSize: 17 }, text: { fontFamily: strictlyType.regular, color: strictlyColors.textSoft, fontSize: 11, lineHeight: 17, textAlign: "center", marginTop: 6 } });
