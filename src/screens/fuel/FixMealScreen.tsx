...
const styles = StyleSheet.create({
  ...
  scoreLabel: { fontFamily: strictlyType.mono, color: strictlyColors.textSoft, fontSize: 11, letterSpacing: 0.3, textAlign: "center" },
  oldScore: { fontFamily: strictlyType.sansMedium, fontWeight: "700", color: strictlyColors.textSoft, fontSize: 37, textAlign: "center", marginTop: 4 },
  newScore: { fontFamily: strictlyType.sansMedium, fontWeight: "700", color: strictlyColors.text, fontSize: 37, textAlign: "center", marginTop: 4 },
  ...
  signText: { fontFamily: strictlyType.sansMedium, fontWeight: "700", color: strictlyColors.onLime, fontSize: 20 },
  fixCopy: { flex: 1 },
  fixTitle: { fontFamily: strictlyType.sansMedium, fontWeight: "700", color: strictlyColors.text, fontSize: 14 },
  fixAmount: { fontFamily: strictlyType.mono, color: strictlyColors.text, fontSize: 11, marginTop: 4 },
  ...
  nextTime: { padding: 16, marginTop: 10, borderRadius: strictlyRadius.large, backgroundColor: strictlyColors.cream }, nextTimeLabel: { fontFamily: strictlyType.mono, color: strictlyColors.textSoft, fontSize: 11, letterSpacing: 0.3, marginBottom: 8 }, nextTimeRow: { flexDirection: "row", gap: 8, marginTop: 6 }, nextTimeText: { flex: 1, fontFamily: strictlyType.sans, color: strictlyColors.text, fontSize: 11, lineHeight: 16 },
  ...
  previewLabel: { fontFamily: strictlyType.mono, color: strictlyColors.sage, fontSize: 11, letterSpacing: 0.3, marginBottom: 7 },
  ...
  previewName: { fontFamily: strictlyType.sans, color: strictlyColors.inverseTextSoft, fontSize: 11 },
  previewValue: { fontFamily: strictlyType.sansMedium, fontWeight: "700", color: strictlyColors.inverseText, fontSize: 12 },
