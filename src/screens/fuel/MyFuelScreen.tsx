...
const styles = StyleSheet.create({
  eyebrow: { fontFamily: strictlyType.semibold, color: strictlyColors.textSoft, fontSize: 11, letterSpacing: 1.1, marginTop: 9 },
  title: { fontFamily: strictlyType.bold,  color: strictlyColors.text, fontSize: 32, letterSpacing: -1, marginTop: 7 },
  subtitle: { fontFamily: strictlyType.regular, color: strictlyColors.textSoft, fontSize: 13, lineHeight: 19, marginTop: 7 },
  ...
  statValue: { fontFamily: strictlyType.bold,  color: strictlyColors.text, fontSize: 24 },
  statLabel: { fontFamily: strictlyType.semibold, color: strictlyColors.textSoft, fontSize: 11, textTransform: "uppercase", marginTop: 3 },
  sectionHead: { flexDirection: "row", justifyContent: "space-between", alignItems: "center", marginTop: 27, marginBottom: 10 },
  sectionTitle: { fontFamily: strictlyType.bold,  color: strictlyColors.text, fontSize: 18 },
  sectionMeta: { fontFamily: strictlyType.semibold, color: strictlyColors.textSoft, fontSize: 11 },
  link: { fontFamily: strictlyType.bold,  color: strictlyColors.text, fontSize: 11 },
  ...
  mealCopy: { flex: 1 },
  mealName: { fontFamily: strictlyType.bold,  color: strictlyColors.text, fontSize: 12 },
  mealMeta: { fontFamily: strictlyType.regular, color: strictlyColors.textSoft, fontSize: 11, marginTop: 3, textTransform: "capitalize" },
  mealDate: { fontFamily: strictlyType.semibold, color: strictlyColors.textSoft, fontSize: 11, marginTop: 4 },
  ...
  emptyTitle: { fontFamily: strictlyType.bold,  color: strictlyColors.text, fontSize: 15 },
  emptyText: { fontFamily: strictlyType.regular, color: strictlyColors.textSoft, fontSize: 11, lineHeight: 15, textAlign: "center", marginTop: 5 },
  ...
  savedEmptyText: { flex: 1, fontFamily: strictlyType.regular, color: strictlyColors.text, fontSize: 11, lineHeight: 16 },
});
