...
const styles = StyleSheet.create({
  eyebrow: { fontFamily: strictlyType.mono, color: strictlyColors.textSoft, fontSize: 11, letterSpacing: 0.3, marginTop: 9 },
  title: { fontFamily: strictlyType.sansMedium, fontWeight: "700", color: strictlyColors.text, fontSize: 32, letterSpacing: -1, marginTop: 7 },
  ...
  statValue: { fontFamily: strictlyType.sansMedium, fontWeight: "700", color: strictlyColors.text, fontSize: 24 },
  statLabel: { fontFamily: strictlyType.mono, color: strictlyColors.textSoft, fontSize: 11, textTransform: "uppercase", marginTop: 3 },
  sectionHead: { flexDirection: "row", justifyContent: "space-between", alignItems: "center", marginTop: 27, marginBottom: 10 },
  sectionTitle: { fontFamily: strictlyType.sansMedium, fontWeight: "700", color: strictlyColors.text, fontSize: 18 },
  sectionMeta: { fontFamily: strictlyType.mono, color: strictlyColors.textSoft, fontSize: 11 },
  link: { fontFamily: strictlyType.sansMedium, fontWeight: "700", color: strictlyColors.text, fontSize: 11 },
  ...
  mealCopy: { flex: 1 },
  mealName: { fontFamily: strictlyType.sansMedium, fontWeight: "700", color: strictlyColors.text, fontSize: 12 },
  mealMeta: { fontFamily: strictlyType.sans, color: strictlyColors.textSoft, fontSize: 11, marginTop: 3, textTransform: "capitalize" },
  mealDate: { fontFamily: strictlyType.mono, color: strictlyColors.textSoft, fontSize: 11, marginTop: 4 },
  ...
  emptyTitle: { fontFamily: strictlyType.sansMedium, fontWeight: "700", color: strictlyColors.text, fontSize: 15 },
  emptyText: { fontFamily: strictlyType.sans, color: strictlyColors.textSoft, fontSize: 11, lineHeight: 15, textAlign: "center", marginTop: 5 },
