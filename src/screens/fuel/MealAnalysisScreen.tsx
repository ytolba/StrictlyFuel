...
const styles = StyleSheet.create({
  missing: { fontFamily: strictlyType.regular, color: strictlyColors.textSoft },
  ...
  doneText: { fontFamily: strictlyType.bold,  color: strictlyColors.text, fontSize: 12 },
  ...
  scoreValue: { fontFamily: strictlyType.bold,  color: strictlyColors.onLime, fontSize: 29, lineHeight: 31 },
  scoreOut: { fontFamily: strictlyType.semibold, color: strictlyColors.onLimeSoft, fontSize: 11 },
  scoreCopy: { flex: 1 },
  scoreBand: { fontFamily: strictlyType.semibold, fontSize: 11, letterSpacing: 1.1, textTransform: "uppercase" },
  scoreTitle: { fontFamily: strictlyType.bold,  color: strictlyColors.text, fontSize: 21, letterSpacing: -0.5, marginTop: 5 },
  scoreText: { fontFamily: strictlyType.regular, color: strictlyColors.textSoft, fontSize: 12, lineHeight: 18, marginTop: 5 },
  ...
  fitLabel: { fontFamily: strictlyType.semibold, color: strictlyColors.textSoft, fontSize: 11, letterSpacing: 1.1 },
  fitText: { fontFamily: strictlyType.bold,  color: strictlyColors.text, fontSize: 17, marginTop: 8 },
  fitCarbs: { fontFamily: strictlyType.bold,  color: strictlyColors.text, fontSize: 28, marginTop: 7, marginBottom: 12 },
  fitUnit: { fontFamily: strictlyType.regular,  color: strictlyColors.textSoft, fontSize: 11 },
  ...
  confidenceText: { flex: 1, fontFamily: strictlyType.regular, color: strictlyColors.textSoft, fontSize: 11, lineHeight: 15 },
  ...
  eatCopy: { flex: 1 },
  eatLabel: { fontFamily: strictlyType.semibold, color: strictlyColors.sage, fontSize: 11, letterSpacing: 1.1 },
  eatTime: { fontFamily: strictlyType.bold,  color: strictlyColors.white, fontSize: 24, marginTop: 3 },
  eatWindow: { fontFamily: strictlyType.regular, color: strictlyColors.sage, fontSize: 11, marginTop: 3 },
  ...
  healthCopy: { flex: 1 },
  healthLabel: { fontFamily: strictlyType.semibold, color: strictlyColors.textSoft, fontSize: 11, letterSpacing: 1.1 },
  healthScore: { fontFamily: strictlyType.bold,  fontSize: 26, marginTop: 5 },
  healthOut: { fontFamily: strictlyType.regular,  fontSize: 11, color: strictlyColors.textSoft },
  healthChip: { width: 40, height: 40, borderRadius: 14, alignItems: "center", justifyContent: "center" },
  healthNote: { fontFamily: strictlyType.regular, color: strictlyColors.textSoft, fontSize: 11, lineHeight: 16, marginTop: 8 },
  healthClean: { fontFamily: strictlyType.regular, color: strictlyColors.good, fontSize: 11, lineHeight: 16, marginTop: 8 },
  ...
  improveText: { fontFamily: strictlyType.bold,  color: strictlyColors.text, fontSize: 12 },
  ...
  suggestionGainText: { fontFamily: strictlyType.bold,  color: strictlyColors.onLime, fontSize: 11 },
  suggestionCopy: { flex: 1 },
  suggestionTitle: { fontFamily: strictlyType.bold,  color: strictlyColors.text, fontSize: 12 },
  suggestionText: { fontFamily: strictlyType.regular, color: strictlyColors.textSoft, fontSize: 11, lineHeight: 16, marginTop: 4 },
  suggestionNote: { fontFamily: strictlyType.regular, color: strictlyColors.textSoft, fontSize: 11, lineHeight: 14, marginTop: 2 },

  sectionTitle: { fontFamily: strictlyType.bold,  color: strictlyColors.text, fontSize: 18, marginTop: 25, marginBottom: 9 },
  ...
  componentTitle: { fontFamily: strictlyType.bold,  color: strictlyColors.text, fontSize: 13 },
  componentScore: { fontFamily: strictlyType.semibold, fontSize: 11 },
  componentText: { fontFamily: strictlyType.regular, color: strictlyColors.textSoft, fontSize: 11, lineHeight: 17, marginTop: 5 },
  ...
  fixCopy: { flex: 1 },
  fixTitle: { fontFamily: strictlyType.bold,  color: strictlyColors.onLime, fontSize: 16 },
  fixText: { fontFamily: strictlyType.regular, color: strictlyColors.onLimeSoft, fontSize: 11, marginTop: 3 },
  ...
  shareText: { fontFamily: strictlyType.bold,  color: strictlyColors.text },

  home: { height: 48, flexDirection: "row", gap: 7, alignItems: "center", justifyContent: "center", marginTop: 4 },
  homeText: { fontFamily: strictlyType.bold,  color: strictlyColors.textSoft, fontSize: 12 },

  disclaimer: { fontFamily: strictlyType.regular, color: strictlyColors.textSoft, fontSize: 11, lineHeight: 14, marginTop: 12 },
});
