...
const styles = StyleSheet.create({
  ...
  doneText: { fontFamily: strictlyType.sansMedium, fontWeight: "700", color: strictlyColors.text, fontSize: 12 },
  ...
  scoreValue: { fontFamily: strictlyType.sansMedium, fontWeight: "700", color: strictlyColors.onLime, fontSize: 29, lineHeight: 31 },
  scoreOut: { fontFamily: strictlyType.mono, color: strictlyColors.onLimeSoft, fontSize: 11 },
  scoreCopy: { flex: 1 },
  scoreBand: { fontFamily: strictlyType.mono, fontSize: 11, letterSpacing: 0.3, textTransform: "uppercase" },
  scoreTitle: { fontFamily: strictlyType.sansMedium, fontWeight: "700", color: strictlyColors.text, fontSize: 21, letterSpacing: -0.5, marginTop: 5 },
  ...
  fitLabel: { fontFamily: strictlyType.mono, color: strictlyColors.textSoft, fontSize: 11, letterSpacing: 0.3 },
  fitText: { fontFamily: strictlyType.sansMedium, fontWeight: "700", color: strictlyColors.text, fontSize: 17, marginTop: 8 },
  fitCarbs: { fontFamily: strictlyType.sansMedium, fontWeight: "700", color: strictlyColors.text, fontSize: 28, marginTop: 7, marginBottom: 12 },
  ...
  confidenceText: { flex: 1, fontFamily: strictlyType.sans, color: strictlyColors.textSoft, fontSize: 11, lineHeight: 15 },
  ...
  eatCopy: { flex: 1 },
  eatLabel: { fontFamily: strictlyType.mono, color: strictlyColors.sage, fontSize: 11, letterSpacing: 0.3 },
  eatTime: { fontFamily: strictlyType.sansMedium, fontWeight: "700", color: strictlyColors.white, fontSize: 24, marginTop: 3 },
  eatWindow: { fontFamily: strictlyType.sans, color: strictlyColors.sage, fontSize: 11, marginTop: 3 },
  ...
  healthCopy: { flex: 1 },
  healthLabel: { fontFamily: strictlyType.mono, color: strictlyColors.textSoft, fontSize: 11, letterSpacing: 0.3 },
  healthScore: { fontFamily: strictlyType.sansMedium, fontWeight: "700", fontSize: 26, marginTop: 5 },
  ...
  improveText: { fontFamily: strictlyType.sansMedium, fontWeight: "700", color: strictlyColors.text, fontSize: 12 },
  ...
  suggestionGainText: { fontFamily: strictlyType.sansMedium, fontWeight: "700", color: strictlyColors.onLime, fontSize: 11 },
  suggestionCopy: { flex: 1 },
  suggestionTitle: { fontFamily: strictlyType.sansMedium, fontWeight: "700", color: strictlyColors.text, fontSize: 12 },
  suggestionText: { fontFamily: strictlyType.sans, color: strictlyColors.textSoft, fontSize: 11, lineHeight: 16, marginTop: 4 },
  suggestionNote: { fontFamily: strictlyType.sans, color: strictlyColors.textSoft, fontSize: 11, lineHeight: 14, marginTop: 2 },

  sectionTitle: { fontFamily: strictlyType.sansMedium, fontWeight: "700", color: strictlyColors.text, fontSize: 18, marginTop: 25, marginBottom: 9 },
  ...
  componentTitle: { fontFamily: strictlyType.sansMedium, fontWeight: "700", color: strictlyColors.text, fontSize: 13 },
  componentScore: { fontFamily: strictlyType.mono, fontSize: 11 },
  ...
  fixCopy: { flex: 1 },
  fixTitle: { fontFamily: strictlyType.sansMedium, fontWeight: "700", color: strictlyColors.onLime, fontSize: 16 },
  ...
  shareText: { fontFamily: strictlyType.sansMedium, fontWeight: "700", color: strictlyColors.text },
  ...
  disclaimer: { fontFamily: strictlyType.sans, color: strictlyColors.textSoft, fontSize: 11, lineHeight: 14, marginTop: 12 },
});
