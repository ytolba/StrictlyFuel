...
const styles = StyleSheet.create({
  ...
  targetLabel: { fontFamily: strictlyType.mono, color: strictlyColors.sage, fontSize: 11, letterSpacing: 0.3 },
  targetValue: { fontFamily: strictlyType.sansMedium, fontWeight: "700", color: strictlyColors.white, fontSize: 20, marginTop: 2 },
  ...
  actual: { minWidth: 42, textAlign: "right", fontFamily: strictlyType.sansMedium, fontWeight: "700", color: strictlyColors.white, fontSize: 16 },
  ...
  noResultsTitle: { fontFamily: strictlyType.sansMedium, fontWeight: "700", color: strictlyColors.text, fontSize: 15 },
  ...
  captureText: { fontFamily: strictlyType.sansMedium, fontWeight: "700", color: strictlyColors.onLime, fontSize: 12 },
  ...
  foodMeta: { fontFamily: strictlyType.sans, color: strictlyColors.textSoft, fontSize: 11, marginTop: 3, textTransform: "capitalize" },
  ...
  sectionTitle: { fontFamily: strictlyType.sansMedium, fontWeight: "700", color: strictlyColors.text, fontSize: 18, marginTop: 24, marginBottom: 9 },
  count: { fontFamily: strictlyType.mono, color: strictlyColors.textSoft, fontSize: 11 },
  ...
  g: { fontFamily: strictlyType.sans, color: strictlyColors.textSoft, fontSize: 11 },
  ...
  compareLabel: { flex: 1, textAlign: "right", fontFamily: strictlyType.mono, color: strictlyColors.textSoft, fontSize: 11, letterSpacing: 0.3 },
  ...
  onTarget: { color: strictlyColors.good, fontWeight: "700" },
  ...
  macroValue: { fontFamily: strictlyType.sansMedium, fontWeight: "700", color: strictlyColors.text, fontSize: 15 },
  macroLabel: { fontFamily: strictlyType.mono, color: strictlyColors.textSoft, fontSize: 11, textTransform: "uppercase", marginTop: 3 },
  ...
  source: { fontFamily: strictlyType.sans, color: strictlyColors.textSoft, fontSize: 11, lineHeight: 14, marginTop: 11 },
});
