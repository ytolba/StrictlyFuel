...
const styles = StyleSheet.create({
  ...
  sectionLabel: { marginTop: 23, marginBottom: 8, fontFamily: strictlyType.mono, color: strictlyColors.textSoft, fontSize: 11, letterSpacing: 0.3 },
  races: { flexDirection: "row", flexWrap: "wrap", gap: 7 }, race: { width: "48%", minHeight: 68, padding: 11, borderRadius: strictlyRadius.medium, backgroundColor: strictlyColors.surface, borderWidth: 1, borderColor: strictlyColors.border }, raceActive: { backgroundColor: strictlyColors.ink, borderColor: strictlyColors.ink }, raceName: { fontFamily: strictlyType.sansMedium, fontWeight: "700", color: strictlyColors.text, fontSize: 12 }, raceNameActive: { color: strictlyColors.white }, raceDistance: { marginTop: 5, fontFamily: strictlyType.sans, color: strictlyColors.textSoft, fontSize: 11, lineHeight: 12 }, raceDistanceActive: { color: strictlyColors.sage },
  inputs: { flexDirection: "row", gap: 8, marginTop: 10 }, input: { flex: 1, minHeight: 78, padding: 12, borderRadius: strictlyRadius.medium, backgroundColor: strictlyColors.surface, borderWidth: 1, borderColor: strictlyColors.border }, inputLabel: { fontFamily: strictlyType.mono, color: strictlyColors.textSoft, fontSize: 11, letterSpacing: 0.3 }, inputValue: { flex: 1, marginTop: 7, fontFamily: strictlyType.sansMedium, fontWeight: "700", color: strictlyColors.text, fontSize: 18 },
  segment: { flexDirection: "row", padding: 3, borderRadius: strictlyRadius.medium, backgroundColor: strictlyColors.surfaceMuted }, segmentItem: { flex: 1, minHeight: 45, paddingHorizontal: 5, alignItems: "center", justifyContent: "center", borderRadius: 9 }, segmentActive: { backgroundColor: strictlyColors.lime }, segmentText: { textAlign: "center", fontFamily: strictlyType.sansMedium, color: strictlyColors.textSoft, fontSize: 11 }, segmentTextActive: { color: strictlyColors.onLime, fontWeight: "700" }, helper: { marginTop: 7, fontFamily: strictlyType.sans, color: strictlyColors.textSoft, fontSize: 11, lineHeight: 14 },
  intervalRow: { flexDirection: "row", gap: 8 }, interval: { flex: 1, height: 44, alignItems: "center", justifyContent: "center", borderRadius: strictlyRadius.pill, backgroundColor: strictlyColors.surface, borderWidth: 1, borderColor: strictlyColors.border }, intervalActive: { borderColor: strictlyColors.accentText, backgroundColor: strictlyColors.cream }, intervalText: { fontFamily: strictlyType.sansMedium, color: strictlyColors.textSoft, fontSize: 11 }, intervalTextActive: { color: strictlyColors.text, fontWeight: "700" },
  primary: { minHeight: 56, marginTop: 17, paddingHorizontal: 17, flexDirection: "row", gap: 8, alignItems: "center", justifyContent: "center", borderRadius: strictlyRadius.medium, backgroundColor: strictlyColors.lime }, primaryText: { fontFamily: strictlyType.sansMedium, fontWeight: "700", color: strictlyColors.onLime, fontSize: 13 },
  plan: { marginTop: 27 }, summary: { padding: 20, borderRadius: strictlyRadius.xlarge, backgroundColor: strictlyColors.ink, borderWidth: 1, borderColor: strictlyColors.border }, summaryEyebrow: { fontFamily: strictlyType.mono, color: strictlyColors.sage, fontSize: 11, letterSpacing: 0.3 }, summaryValue: { marginTop: 8, fontFamily: strictlyType.sansMedium, fontWeight: "700", color: strictlyColors.white, fontSize: 48, letterSpacing: -2 }, summaryLabel: { fontFamily: strictlyType.sans, color: strictlyColors.inverseTextSoft, fontSize: 11 }, summaryStats: { marginTop: 18, paddingTop: 15, flexDirection: "row", justifyContent: "space-between", borderTopWidth: 1, borderTopColor: strictlyColors.overlayLine }, summaryStatValue: { fontFamily: strictlyType.sansMedium, fontWeight: "700", color: strictlyColors.white, fontSize: 14 }, summaryStatLabel: { marginTop: 3, fontFamily: strictlyType.mono, color: strictlyColors.sage, fontSize: 11, letterSpacing: 0.3 },
  planTitle: { marginTop: 26, marginBottom: 9, fontFamily: strictlyType.sansMedium, fontWeight: "700", color: strictlyColors.text, fontSize: 19 }, preRace: { flexDirection: "row", gap: 11, padding: 15, borderRadius: strictlyRadius.large, backgroundColor: strictlyColors.cream }, preRaceCopy: { flex: 1 }, preRaceValue: { fontFamily: strictlyType.sansMedium, fontWeight: "700", color: strictlyColors.text, fontSize: 14 }, preRaceText: { marginTop: 4, fontFamily: strictlyType.sans, color: strictlyColors.textSoft, fontSize: 11, lineHeight: 15 },
  segmentCard: { marginBottom: 9, padding: 15, borderRadius: strictlyRadius.large, backgroundColor: strictlyColors.surface, borderWidth: 1, borderColor: strictlyColors.border }, segmentHead: { flexDirection: "row", justifyContent: "space-between", gap: 10 }, segmentTitle: { fontFamily: strictlyType.sansMedium, fontWeight: "700", color: strictlyColors.text, fontSize: 16 }, segmentMeta: { marginTop: 3, fontFamily: strictlyType.sans, color: strictlyColors.textSoft, fontSize: 11 }, segmentTarget: { fontFamily: strictlyType.sansMedium, fontWeight: "700", color: strictlyColors.accentText, fontSize: 17 }, packRow: { flexDirection: "row", gap: 10, marginTop: 12, paddingTop: 12, borderTopWidth: 1, borderTopColor: strictlyColors.border }, packCount: { width: 36, height: 36, borderRadius: 12, alignItems: "center", justifyContent: "center", backgroundColor: strictlyColors.lime }, packCountText: { fontFamily: strictlyType.sansMedium, fontWeight: "700", color: strictlyColors.onLime, fontSize: 12 }, packCopy: { flex: 1 }, packName: { fontFamily: strictlyType.sansMedium, fontWeight: "700", color: strictlyColors.text, fontSize: 12, textTransform: "capitalize" }, packNote: { marginTop: 3, fontFamily: strictlyType.sans, color: strictlyColors.textSoft, fontSize: 11, lineHeight: 14 }, noFuel: { marginTop: 12, fontFamily: strictlyType.sans, color: strictlyColors.textSoft, fontSize: 11, lineHeight: 15 },
  timeline: { borderRadius: strictlyRadius.large, overflow: "hidden", borderWidth: 1, borderColor: strictlyColors.border }, stop: { minHeight: 61, padding: 11, flexDirection: "row", alignItems: "center", gap: 11, backgroundColor: strictlyColors.surface, borderBottomWidth: 1, borderBottomColor: strictlyColors.border }, stopTime: { width: 53, height: 34, borderRadius: strictlyRadius.pill, alignItems: "center", justifyContent: "center", backgroundColor: strictlyColors.cream }, stopTimeText: { fontFamily: strictlyType.mono, color: strictlyColors.text, fontSize: 11 }, stopCopy: { flex: 1 }, stopTitle: { fontFamily: strictlyType.sansMedium, fontWeight: "700", color: strictlyColors.text, fontSize: 11 }, stopText: { marginTop: 2, fontFamily: strictlyType.sans, color: strictlyColors.textSoft, fontSize: 11 },
  practice: { marginTop: 13, flexDirection: "row", gap: 10, padding: 15, borderRadius: strictlyRadius.large, backgroundColor: strictlyColors.cream }, practiceText: { flex: 1, fontFamily: strictlyType.sans, color: strictlyColors.text, fontSize: 11, lineHeight: 16 }, hydration: { marginTop: 9, padding: 15, borderRadius: strictlyRadius.large, backgroundColor: strictlyColors.surface, borderWidth: 1, borderColor: strictlyColors.border }, hydrationTitle: { fontFamily: strictlyType.sansMedium, fontWeight: "700", color: strictlyColors.text, fontSize: 12 }, hydrationText: { marginTop: 4, fontFamily: strictlyType.sans, color: strictlyColors.textSoft, fontSize: 11, lineHeight: 15 },
  source: { minHeight: 46, flexDirection: "row", alignItems: "center", gap: 8, paddingHorizontal: 13, marginBottom: 7, borderRadius: strictlyRadius.medium, backgroundColor: strictlyColors.surface }, sourceText: { flex: 1, fontFamily: strictlyType.sansMedium, color: strictlyColors.text, fontSize: 11 }, disclaimer: { marginTop: 12, fontFamily: strictlyType.sans, color: strictlyColors.textSoft, fontSize: 11, lineHeight: 13, textAlign: "center" },
});
