...
const styles = StyleSheet.create({
  ...
  sectionLabel: { marginTop: 23, marginBottom: 8, fontFamily: strictlyType.mono, color: strictlyColors.textSoft, fontSize: 8, letterSpacing: 1.3 },
  races: { flexDirection: "row", flexWrap: "wrap", gap: 7 }, race: { width: "48%", minHeight: 68, padding: 11, borderRadius: strictlyRadius.medium, backgroundColor: strictlyColors.surface, borderWidth: 1, borderColor: strictlyColors.border }, raceActive: { backgroundColor: strictlyColors.ink, borderColor: strictlyColors.ink }, raceName: { fontFamily: strictlyType.sansMedium, fontWeight: "800", color: strictlyColors.text, fontSize: 12 }, raceNameActive: { color: strictlyColors.white }, raceDistance: { marginTop: 5, fontFamily: strictlyType.sans, color: strictlyColors.textSoft, fontSize: 8, lineHeight: 12 }, raceDistanceActive: { color: strictlyColors.sage },
  inputs: { flexDirection: "row", gap: 8, marginTop: 10 }, input: { flex: 1, minHeight: 78, padding: 12, borderRadius: strictlyRadius.medium, backgroundColor: strictlyColors.surface, borderWidth: 1, borderColor: strictlyColors.border }, inputLabel: { fontFamily: strictlyType.mono, color: strictlyColors.textSoft, fontSize: 7, letterSpacing: 0.8 }, inputValue: { flex: 1, marginTop: 7, fontFamily: strictlyType.sansMedium, fontWeight: "900", color: strictlyColors.text, fontSize: 18 },
  segment: { flexDirection: "row", padding: 3, borderRadius: strictlyRadius.medium, backgroundColor: strictlyColors.surfaceMuted }, segmentItem: { flex: 1, minHeight: 45, paddingHorizontal: 5, alignItems: "center", justifyContent: "center", borderRadius: 9 }, segmentActive: { backgroundColor: strictlyColors.lime }, segmentText: { textAlign: "center", fontFamily: strictlyType.sansMedium, color: strictlyColors.textSoft, fontSize: 9 }, segmentTextActive: { color: strictlyColors.onLime, fontWeight: "800" }, helper: { marginTop: 7, fontFamily: strictlyType.sans, color: strictlyColors.textSoft, fontSize: 9, lineHeight: 14 },
  intervalRow: { flexDirection: "row", gap: 8 }, interval: { flex: 1, height: 44, alignItems: "center", justifyContent: "center", borderRadius: strictlyRadius.pill, backgroundColor: strictlyColors.surface, borderWidth: 1, borderColor: strictlyColors.border }, intervalActive: { borderColor: strictlyColors.accentText, backgroundColor: strictlyColors.cream }, intervalText: { fontFamily: strictlyType.sansMedium, color: strictlyColors.textSoft, fontSize: 11 }, intervalTextActive: { color: strictlyColors.text, fontWeight: "800" },
  primary: { minHeight: 56, marginTop: 17, paddingHorizontal: 17, flexDirection: "row", gap: 8, alignItems: "center", justifyContent: "center", borderRadius: strictlyRadius.medium, backgroundColor: strictlyColors.lime }, primaryText: { fontFamily: strictlyType.sansMedium, fontWeight: "900", color: strictlyColors.onLime, fontSize: 13 },
  plan: { marginTop: 27 }, summary: { padding: 20, borderRadius: strictlyRadius.xlarge, backgroundColor: strictlyColors.ink }, summaryEyebrow: { fontFamily: strictlyType.mono, color: strictlyColors.sage, fontSize: 8, letterSpacing: 1.2 }, summaryValue: { marginTop: 8, fontFamily: strictlyType.sansMedium, fontWeight: "900", color: strictlyColors.white, fontSize: 48, letterSpacing: -2 }, summaryLabel: { fontFamily: strictlyType.sans, color: strictlyColors.inverseTextSoft, fontSize: 11 }, summaryStats: { marginTop: 18, paddingTop: 15, flexDirection: "row", justifyContent: "space-between", borderTopWidth: 1, borderTopColor: strictlyColors.overlayLine }, summaryStatValue: { fontFamily: strictlyType.sansMedium, fontWeight: "800", color: strictlyColors.white, fontSize: 14 }, summaryStatLabel: { marginTop: 3, fontFamily: strictlyType.mono, color: strictlyColors.sage, fontSize: 7, letterSpacing: 0.8 },
  planTitle: { marginTop: 26, marginBottom: 9, fontFamily: strictlyType.sansMedium, fontWeight: "900", color: strictlyColors.text, fontSize: 19 }, preRace: { flexDirection: "row", gap: 11, padding: 15, borderRadius: strictlyRadius.large, backgroundColor: strictlyColors.cream }, preRaceCopy: { flex: 1 }, preRaceValue: { fontFamily: strictlyType.sansMedium, fontWeight: "900", color: strictlyColors.text, fontSize: 14 }, preRaceText: { marginTop: 4, fontFamily: strictlyType.sans, color: strictlyColors.textSoft, fontSize: 10, lineHeight: 15 },
  segmentCard: { marginBottom: 9, padding: 15, borderRadius: strictlyRadius.large, backgroundColor: strictlyColors.surface, borderWidth: 1, borderColor: strictlyColors.border }, segmentHead: { flexDirection: "row", justifyContent: "space-between", gap: 10 }, segmentTitle: { fontFamily: strictlyType.sansMedium, fontWeight: "900", color: strictlyColors.text, fontSize: 16 }, segmentMeta: { marginTop: 3, fontFamily: strictlyType.sans, color: strictlyColors.textSoft, fontSize: 9 }, segmentTarget: { fontFamily: strictlyType.sansMedium, fontWeight: "900", color: strictlyColors.accentText, fontSize: 17 }, packRow: { flexDirection: "row", gap: 10, marginTop: 12, paddingTop: 12, borderTopWidth: 1, borderTopColor: strictlyColors.border }, packCount: { width: 36, height: 36, borderRadius: 12, alignItems: "center", justifyContent: "center", backgroundColor: strictlyColors.lime }, packCountText: { fontFamily: strictlyType.sansMedium, fontWeight: "900", color: strictlyColors.onLime, fontSize: 12 }, packCopy: { flex: 1 }, packName: { fontFamily: strictlyType.sansMedium, fontWeight: "800", color: strictlyColors.text, fontSize: 12, textTransform: "capitalize" }, packNote: { marginTop: 3, fontFamily: strictlyType.sans, color: strictlyColors.textSoft, fontSize: 9, lineHeight: 14 }, noFuel: { marginTop: 12, fontFamily: strictlyType.sans, color: strictlyColors.textSoft, fontSize: 10, lineHeight: 15 },
