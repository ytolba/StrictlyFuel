...
const styles = StyleSheet.create({
  ...
  races: { flexDirection: "row", flexWrap: "wrap", gap: 7 }, race: { width: "48%", minHeight: 68, padding: 11, borderRadius: strictlyRadius.medium, backgroundColor: strictlyColors.surface, borderWidth: 1, borderColor: strictlyColors.border }, raceActive: { backgroundColor: strictlyColors.ink, borderColor: strictlyColors.ink }, raceName: { fontFamily: strictlyType.bold,  color: strictlyColors.text, fontSize: 12 }, raceNameActive: { color: strictlyColors.white }, raceDistance: { marginTop: 5, fontFamily: strictlyType.regular, color: strictlyColors.textSoft, fontSize: 11, lineHeight: 12 }, raceDistanceActive: { color: strictlyColors.sage },
