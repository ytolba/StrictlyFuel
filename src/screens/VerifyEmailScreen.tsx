...
const styles = StyleSheet.create({
  safe: { flex: 1, backgroundColor: strictlyColors.background }, container: { flex: 1, alignItems: "center", justifyContent: "center", paddingHorizontal: 24 }, icon: { width: 84, height: 84, borderRadius: 28, alignItems: "center", justifyContent: "center", backgroundColor: strictlyColors.ink }, eyebrow: { marginTop: 23, fontFamily: strictlyType.mono, color: strictlyColors.good, fontSize: 11, letterSpacing: 0.3 }, title: { fontFamily: strictlyType.sansMedium, fontWeight: "700", color: strictlyColors.text, fontSize: 31, letterSpacing: -1, marginTop: 7 }, subtitle: { maxWidth: 350, textAlign: "center", fontFamily: strictlyType.sans, color: strictlyColors.textSoft, fontSize: 14, lineHeight: 21, marginTop: 9 }, email: { color: strictlyColors.text, fontFamily: strictlyType.sansMedium, fontWeight: "700" },
  ...
  primary: { width: "100%", maxWidth: 430, height: 54, marginTop: 16, borderRadius: strictlyRadius.medium, backgroundColor: strictlyColors.lime, flexDirection: "row", gap: 8, alignItems: "center", justifyContent: "center" }, primaryText: { fontFamily: strictlyType.sansMedium, fontWeight: "700", color: strictlyColors.onLime, fontSize: 13 }, resend: { height: 48, alignItems: "center", justifyContent: "center" }, resendText: { fontFamily: strictlyType.sansMedium, fontWeight: "700", color: strictlyColors.text, fontSize: 12 }, note: { maxWidth: 330, textAlign: "center", fontFamily: strictlyType.sans, color: strictlyColors.textSoft, fontSize: 11, lineHeight: 14 },
});
