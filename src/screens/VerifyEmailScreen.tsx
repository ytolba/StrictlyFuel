...
export default function VerifyEmailScreen() {
  ...
  return <SafeAreaView style={styles.safe}><View style={styles.container}>
    <View style={styles.icon}><Ionicons name="mail-unread-outline" size={36} color={strictlyColors.lime} /></View>
...
const styles = StyleSheet.create({
  safe: { flex: 1, backgroundColor: strictlyColors.background }, container: { flex: 1, alignItems: "center", justifyContent: "center", paddingHorizontal: 24 }, icon: { width: 84, height: 84, borderRadius: 28, alignItems: "center", justifyContent: "center", backgroundColor: strictlyColors.ink }, eyebrow: { marginTop: 23, fontFamily: strictlyType.semibold, color: strictlyColors.good, fontSize: 11, letterSpacing: 1.1 }, title: { fontFamily: strictlyType.bold,  color: strictlyColors.text, fontSize: 31, letterSpacing: -1, marginTop: 7 }, subtitle: { maxWidth: 350, textAlign: "center", fontFamily: strictlyType.regular, color: strictlyColors.textSoft, fontSize: 14, lineHeight: 21, marginTop: 9 }, email: { color: strictlyColors.text, fontFamily: strictlyType.bold},
  tip: { width: "100%", maxWidth: 430, flexDirection: "row", gap: 10, padding: 14, marginTop: 22, borderRadius: strictlyRadius.large, backgroundColor: strictlyColors.cream }, tipText: { flex: 1, fontFamily: strictlyType.regular, color: strictlyColors.text, fontSize: 11, lineHeight: 17 }, message: { marginTop: 12, fontFamily: strictlyType.medium, color: strictlyColors.good, fontSize: 11, textAlign: "center" },
  primary: { width: "100%", maxWidth: 430, height: 54, marginTop: 16, borderRadius: strictlyRadius.medium, backgroundColor: strictlyColors.lime, flexDirection: "row", gap: 8, alignItems: "center", justifyContent: "center" }, primaryText: { fontFamily: strictlyType.bold,  color: strictlyColors.onLime, fontSize: 13 }, resend: { height: 48, alignItems: "center", justifyContent: "center" }, resendText: { fontFamily: strictlyType.bold,  color: strictlyColors.text, fontSize: 12 }, note: { maxWidth: 330, textAlign: "center", fontFamily: strictlyType.regular, color: strictlyColors.textSoft, fontSize: 11, lineHeight: 14 },
});
