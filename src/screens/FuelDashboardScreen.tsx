...
export default function FuelDashboardScreen({ navigation }: any) {
  ...
  return <><ScrollView style={styles.screen} contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
    ...
    <TouchableOpacity style={styles.aiButton} onPress={choosePhoto}><Ionicons name="sparkles" size={19} color={strictlyColors.ink} /><Text style={styles.aiText}>Estimate a meal with AI</Text><Ionicons name="camera-outline" size={19} color={strictlyColors.ink} /></TouchableOpacity>
  ...
  <Modal visible={analyzing || !!analysis} animationType="slide" presentationStyle="pageSheet" onRequestClose={() => !analyzing && setAnalysis(null)}><ScrollView style={styles.modal} contentContainerStyle={styles.modalContent}>
    ...
    {analyzing ? <View style={styles.loading}><ActivityIndicator size="large" color={strictlyColors.ink} /><Text style={styles.loadingTitle}>Reading your plate</Text><Text style={styles.loadingBody}>Estimating portions, preparation, and hidden ingredients.</Text></View> : analysis && <>
